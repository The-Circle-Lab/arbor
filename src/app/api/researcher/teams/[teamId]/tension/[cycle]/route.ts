...
// Team-scoped, no join-code membership check — researcher auth already
...
export async function GET(_req: Request, { params }: { params: Promise<{ teamId: string; cycle: string }> }) {
  try {
    ...
    return NextResponse.json({
      ...
      // what the researcher summary was generated from.
    ...
    console.error('GET /api/researcher/teams/[teamId]/tension/[cycle] error:', e)
