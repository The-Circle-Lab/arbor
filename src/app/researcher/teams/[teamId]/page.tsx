...
import { TeamAgreementView } from '@/components/instructor/TeamAgreementView'
  ...
  useEffect(() => {
    ...
    async function load() {
      try {
        ...
        const agreementsData: { agreements: Agreement[]; resolutions: Resolution[] } = await agreementsRes.json()
        if (ignore) return
        ...
        setResolutions(agreementsData.resolutions)
  ...
  return (
    <main className="min-h-screen bg-stone-50 p-4 md:p-8">
      <div className="max-w-3xl mx-auto">
        ...
        {/* Agreement */}
        <div className="bg-white rounded-2xl shadow-sm border border-stone-100 p-6 mb-6">
          <h2 className="text-lg font-bold text-stone-800 mb-4">Collaboration agreement</h2>
          <TeamAgreementView agreements={agreements} resolutions={resolutions} />
        </div>
